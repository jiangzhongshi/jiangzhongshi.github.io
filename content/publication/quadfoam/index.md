...
summary = "Microstructure family defined on rhombic meshes, with better approximation on (planar) irregular geometric domains. A smoother material-to-geometry map and fabricated results."
...
links = [{name = "Supplemental", url = "https://cims.nyu.edu/gcl/papers/2020-Quad-Foam.zip"}]
